...
class EC2Manager:
    ...
    def upload_flask_apps_to_instances(self) -> None:
        ...
        try:
            ...
            scp = SCPClient(ssh_client.get_transport())
            scp.put("manager_app.py", "manager_app.py")
        ...
        for worker in self.worker_instances:
            try:
                ...
                scp = SCPClient(ssh_client.get_transport())
                scp.put("worker_app.py", "worker_app.py")
            except Exception as e:
                print(
        ...
        try:
            ...
            scp = SCPClient(ssh_client.get_transport())
            scp.put("proxy_app.py", "proxy_app.py")
            scp.put("public_ips.json", "public_ips.json")
        ...
        try:
            ...
            scp = SCPClient(ssh_client.get_transport())
            scp.put("trusted_host_app.py", "trusted_host_app.py")
            scp.put("public_ips.json", "public_ips.json")
        ...
        try:
            ...
            scp = SCPClient(ssh_client.get_transport())
            scp.put("gatekeeper_app.py", "gatekeeper_app.py")
            scp.put("public_ips.json", "public_ips.json")
    ...
    def start_db_cluster_apps(self) -> None:
        ...
        commands = [
            "nohup python3 manager_app.py > manager_output.log 2>&1 &",
        ]
        self.execute_commands(commands, [self.manager_instance])

        commands = [
            "nohup python3 worker_app.py > worker_output.log 2>&1 &",
        ]
    ...
    def start_proxy_app(self) -> None:
        ...
        commands = [
            "nohup python3 proxy_app.py > proxy_output.log 2>&1 &",
        ]
    ...
    def start_trusted_host_app(self) -> None:
        ...
        commands = [
            "nohup python3 trusted_host_app.py > trusted_host_output.log 2>&1 &",
        ]
    ...
    def start_gatekeeper_app(self) -> None:
        ...
        commands = [
            "nohup python3 gatekeeper_app.py > gatekeeper_output.log 2>&1 &",
        ]
...
while True:
    ...
    action = input("Type 'benchmark' to test again, 'cleanup' to clean resources, or any other key to exit: ").strip().lower()
    if action == "benchmark":
        continue
    elif action == "cleanup":
        print("Cleaning up resources...")
        cleanup_resources(ec2_manager)  
